import { FileText, Hash, CheckCircle, Cog } from 'lucide-react';
  ...
  const steps = [
    {
      ...
      description: 'Manufacturer inputs product data locally',
      color: 'from-[#02FDA9] to-[#26D98E]',
    },
    {
      icon: Hash,
      title: 'Generate Commitment',
      description: 'Poseidon hash creates private commitment',
      color: 'from-[#26D98E] to-[#9CF5B4]',
    },
    {
      icon: Cog,
      title: 'Mint veriNFT',
      description: 'Privacy-preserving NFT stored on-chain',
      color: 'from-[#9CF5B4] to-[#02FDA9]',
    },
    {
      icon: CheckCircle,
      title: 'Instant Verification',
      description: 'Consumers verify with zero-knowledge proofs',
